...
import com.example.ungdunggiaitritonghop.BalloonGame.ResultActivity;

import java.util.Random;

public class BalloonGameMain extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_balloon_game_main);
            ...
            public void onFinish() {
                ...
                new CountDownTimer(30000, 1000) {
                    ...
                    public void onFinish() {
                        ...
                        Intent intent = new Intent(BalloonGameMain.this, ResultActivity.class);
    ...
    public void increaseScoreByOne(View view)
    {
        ...
        {
            balloon1.setImageResource(R.drawable.dead);
        }
        if (view.getId() == balloon2.getId())
        {
            balloon2.setImageResource(R.drawable.dead);
        }
        if (view.getId() == balloon3.getId())
        {
            balloon3.setImageResource(R.drawable.dead);
        }
        if (view.getId() == balloon4.getId())
        {
            balloon4.setImageResource(R.drawable.dead);
        }
        if (view.getId() == balloon5.getId())
        {
            balloon5.setImageResource(R.drawable.dead);
        }
        if (view.getId() == balloon6.getId())
        {
            balloon6.setImageResource(R.drawable.dead);
        }
        if (view.getId() == balloon7.getId())
        {
            balloon7.setImageResource(R.drawable.dead);
        }
        if (view.getId() == balloon8.getId())
        {
            balloon8.setImageResource(R.drawable.dead);
        }
        if (view.getId() == balloon9.getId())
        {
            balloon9.setImageResource(R.drawable.dead);
        }
        ...
        runnable = new Runnable() {
            ...
            public void run() {
                ...
                for (ImageView balloon : balloonsArray)
                {
                    ...
                    balloon.setImageResource(R.drawable.hoangdat);
                }
